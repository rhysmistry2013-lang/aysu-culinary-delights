...
export const menu: MenuItem[] = [
  ...
  { id: id(), no: 4, name: "Tarama Salad", description: "Whipped cod roe.", price: 5.5, category: "Cold Starters", diets: H, spice: 0, allergens: ["Fish", "Gluten"] },
  ...
  { id: id(), no: 13, name: "Calamari", description: "Deep-fried squid rings.", price: 6.9, category: "Hot Starters", diets: H, spice: 0, allergens: ["Molluscs", "Gluten"], popular: true },
  ...
  { id: id(), no: 18, name: "Soup of the Day", description: "Please ask your server for today's soup.", price: 5.5, category: "Hot Starters", diets: H, spice: 0, allergens: ["Ask staff"] },
  ...
  { id: id(), no: 27, name: "Lamb Kofte (Adana)", description: "Grilled marinated minced lamb.", price: 10.6, priceLarge: 14.5, category: "Kebabs & Grills", diets: H, spice: 2, allergens: ["Gluten"] },
  { id: id(), no: 28, name: "Chicken Kofte", description: "Grilled marinated minced chicken.", price: 10.5, priceLarge: 14.5, category: "Kebabs & Grills", diets: H, spice: 2, allergens: ["Gluten"] },
  ...
  { id: id(), no: 30, name: "Lamb Shish", description: "Grilled marinated cubes of lamb.", price: 11.5, priceLarge: 17.5, category: "Kebabs & Grills", diets: H, spice: 0, allergens: ["Gluten"], popular: true, image: "shish" },
  { id: id(), no: 31, name: "Chicken Shish", description: "Grilled marinated cubes of chicken breast.", price: 11.5, priceLarge: 15.5, category: "Kebabs & Grills", diets: H, spice: 0, allergens: ["Gluten"], popular: true },
  ...
  { id: id(), no: 33, name: "Lamb Ribs", description: "Eight grilled seasoned lamb ribs.", price: 17.9, category: "Kebabs & Grills", diets: H, spice: 0, allergens: [] },
  { id: id(), no: 34, name: "Lamb Chops", description: "Four grilled seasoned lamb chops.", price: 19.9, category: "Kebabs & Grills", diets: H, spice: 0, allergens: [] },
  ...
  { id: id(), no: 36, name: "Chicken Wings", description: "Eight grilled marinated chicken wings.", price: 13.5, category: "Kebabs & Grills", diets: H, spice: 1, allergens: [] },
  { id: id(), no: 37, name: "Boneless Chicken Leg Steak", description: "Grilled boneless chicken leg steak.", price: 13.5, category: "Kebabs & Grills", diets: H, spice: 0, allergens: [] },
  ...
  { id: id(), no: 52, name: "Vegetarian Skewer", description: "Grilled vegetable skewer, served with rice or chips.", price: 12.9, category: "Vegetarian Dishes", diets: VG, spice: 0, allergens: [] },
  ...
  // Seafood
  { id: id(), no: 54, name: "Sea Bass", description: "Grilled whole sea bass, served with salad and rice or chips.", price: 17.9, category: "Seafood", diets: H, spice: 0, allergens: ["Fish"] },
  { id: id(), no: 55, name: "Salmon", description: "Grilled salmon fillet, served with salad and rice or chips.", price: 17.9, category: "Seafood", diets: H, spice: 0, allergens: ["Fish"] },
  { id: id(), no: 56, name: "King Prawn", description: "Grilled king prawns, served with salad and rice or chips.", price: 17.9, category: "Seafood", diets: H, spice: 0, allergens: ["Crustaceans"] },
  { id: id(), no: 57, name: "Calamari Main", description: "Deep-fried squid, served with salad and chips.", price: 13.5, category: "Seafood", diets: H, spice: 0, allergens: ["Molluscs", "Gluten"] },

  // Daily stews
  { id: id(), no: 58, name: "Lamb Stew", description: "Lamb casserole with rice, bread and salad.", price: 15.9, category: "Daily Stews", diets: H, spice: 0, allergens: ["Gluten"], popular: true },
  { id: id(), no: 59, name: "Chicken Stew", description: "Chicken casserole with rice, bread and salad.", price: 13.9, category: "Daily Stews", diets: H, spice: 0, allergens: ["Gluten"] },
  { id: id(), no: 60, name: "Lentil & Veal", description: "Lentils with veal, served with rice and bread.", price: 12.9, category: "Daily Stews", diets: H, spice: 0, allergens: ["Gluten"] },
  ...
  { id: id(), no: 71, name: "Side Salad", description: "Mixed salad. Small or large.", price: 2.5, priceLarge: 3.5, category: "Sides & Extras", diets: VG, spice: 0, allergens: [] },
  ...
  { id: id(), name: "Nutella Pancakes", description: "Pancakes with Nutella and strawberries.", price: 8.9, category: "Breakfast & Brunch", diets: V, spice: 0, allergens: ["Gluten", "Egg", "Milk", "Nuts"] },
  ...
  { id: id(), name: "Fresh Juice", description: "Juice; please ask which flavours are available.", category: "Drinks", diets: VG, spice: 0, allergens: [] },
